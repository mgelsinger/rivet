...
use crate::{
    editor::scintilla::{
        messages::{
            ...
            SCE_C_COMMENT, SCE_C_COMMENTLINE, SCE_C_COMMENTDOC,
            SCE_C_NUMBER, SCE_C_WORD, SCE_C_STRING, SCE_C_CHARACTER,
            SCE_C_PREPROCESSOR, SCE_C_OPERATOR, SCE_C_REGEX, SCE_C_WORD2,
            // SCLEX_PYTHON token styles
            SCE_P_COMMENTLINE, SCE_P_NUMBER, SCE_P_STRING, SCE_P_CHARACTER,
            SCE_P_WORD, SCE_P_TRIPLE, SCE_P_TRIPLEDOUBLE, SCE_P_CLASSNAME,
            SCE_P_DEFNAME, SCE_P_OPERATOR, SCE_P_DECORATOR,
            // SCLEX_RUST token styles
            SCE_RUST_COMMENTBLOCK, SCE_RUST_COMMENTLINE,
            SCE_RUST_COMMENTBLOCKDOC, SCE_RUST_COMMENTLINEDOC,
            SCE_RUST_NUMBER, SCE_RUST_WORD, SCE_RUST_WORD2,
            SCE_RUST_STRING, SCE_RUST_STRINGR, SCE_RUST_CHARACTER,
            SCE_RUST_OPERATOR, SCE_RUST_LIFETIME, SCE_RUST_MACRO,
            // SCLEX_HTML / SCLEX_XML token styles
            SCE_H_TAG, SCE_H_ATTRIBUTE, SCE_H_DOUBLESTRING, SCE_H_SINGLESTRING,
            SCE_H_COMMENT, SCE_H_TAGEND,
            // SCLEX_CSS token styles
            SCE_CSS_TAG, SCE_CSS_CLASS, SCE_CSS_PSEUDOCLASS, SCE_CSS_OPERATOR,
            SCE_CSS_IDENTIFIER, SCE_CSS_VALUE, SCE_CSS_COMMENT, SCE_CSS_ID,
            SCE_CSS_IMPORTANT, SCE_CSS_SINGLESTRING, SCE_CSS_DOUBLESTRING,
            // SCLEX_JSON token styles
            SCE_JSON_NUMBER, SCE_JSON_STRING, SCE_JSON_PROPERTYNAME,
            SCE_JSON_OPERATOR, SCE_JSON_KEYWORD,
            // SCLEX_SQL token styles
            SCE_SQL_COMMENT, SCE_SQL_COMMENTLINE, SCE_SQL_COMMENTDOC,
            SCE_SQL_NUMBER, SCE_SQL_WORD, SCE_SQL_STRING, SCE_SQL_CHARACTER,
            SCE_SQL_OPERATOR,
            // SCLEX_TOML token styles
            SCE_TOML_COMMENT, SCE_TOML_SECTIONTITLE, SCE_TOML_KEY,
            SCE_TOML_NUMBER, SCE_TOML_STRING, SCE_TOML_STRINGMULTILINE, SCE_TOML_BOOL,
            // SCLEX_PROPERTIES token styles
            SCE_PROPS_COMMENT, SCE_PROPS_SECTION, SCE_PROPS_KEY,
            // SCLEX_BATCH token styles
            SCE_BAT_COMMENT, SCE_BAT_WORD, SCE_BAT_LABEL, SCE_BAT_COMMAND, SCE_BAT_OPERATOR,
            // SCLEX_MAKEFILE token styles
            SCE_MAKE_COMMENT, SCE_MAKE_PREPROCESSOR, SCE_MAKE_TARGET, SCE_MAKE_OPERATOR,
            // SCLEX_DIFF token styles
            SCE_DIFF_COMMENT, SCE_DIFF_COMMAND, SCE_DIFF_HEADER,
            SCE_DIFF_POSITION, SCE_DIFF_DELETED, SCE_DIFF_ADDED,
            // SCLEX_BASH token styles
            SCE_SH_COMMENTLINE, SCE_SH_NUMBER, SCE_SH_WORD, SCE_SH_STRING,
            SCE_SH_CHARACTER, SCE_SH_OPERATOR, SCE_SH_SCALAR,
            // SCLEX_MARKDOWN token styles
            SCE_MARKDOWN_STRONG1, SCE_MARKDOWN_STRONG2, SCE_MARKDOWN_EM1, SCE_MARKDOWN_EM2,
            ...
            SCE_MARKDOWN_STRIKEOUT, SCE_MARKDOWN_HRULE, SCE_MARKDOWN_LINK,
            SCE_MARKDOWN_CODE, SCE_MARKDOWN_CODE2, SCE_MARKDOWN_CODEBK,
            // SCLEX_YAML token styles
            SCE_YAML_COMMENT, SCE_YAML_IDENTIFIER, SCE_YAML_KEYWORD, SCE_YAML_NUMBER,
            SCE_YAML_DOCUMENT, SCE_YAML_TEXT, SCE_YAML_OPERATOR,
            // SCLEX_POWERSHELL token styles
            SCE_POWERSHELL_COMMENT, SCE_POWERSHELL_STRING, SCE_POWERSHELL_CHARACTER,
            SCE_POWERSHELL_NUMBER, SCE_POWERSHELL_VARIABLE, SCE_POWERSHELL_OPERATOR,
            SCE_POWERSHELL_KEYWORD, SCE_POWERSHELL_CMDLET, SCE_POWERSHELL_FUNCTION,
            SCE_POWERSHELL_COMMENTSTREAM, SCE_POWERSHELL_HERE_STRING,
